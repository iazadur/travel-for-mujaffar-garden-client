        ...
        <>
            ...
            <div className="my-10 container mx-auto">
                <div className="flex justify-center items-center">
                    <p>Mozaffar Garden & Resort is situated on 100 acres of fine property. It is in the heart of Satkhira, only two hours away from the Sundarbans with all the transport facilities, but it is enough away from the crowd of the busy town.
