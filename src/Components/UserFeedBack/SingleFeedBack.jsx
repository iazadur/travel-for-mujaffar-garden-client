...
const SingleFeedBack = ({ username, image, review, rating }) => {
    return (
        <>
           <div className="container px-5 py-12 mx-auto">
            <div className="xl:w-1/2 lg:w-3/4 w-full mx-auto text-center bg-gray-50 p-4 shadow-lg">
                
                <p className="leading-relaxed poppins text-gray-500 flex justify-around"> <ImQuotesLeft/>{review}<ImQuotesRight/></p>
